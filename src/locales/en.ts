const translations = {
  ...
  "error_400_toast": {
    "title": "Bad Request",
    "description": "The request could not be processed due to incorrect format or data."
  },
  "error_401_toast": {
    "title": "Unauthorized",
  ...
  "master_data_navs": {
    "qurban_product": "Qurban Product",
    "aqiqah_product": "Aqiqah Product",
    "sadaqah_product": "Sadaqah Product",
    "animal": "Animal",
  ...
  "navs": {
    "dashboard": "Dashboard",
    "product": "Product",
    "qurban_product": "Qurban",
    "aqiqah_product": "Aqiqah",
    "sadaqah_product": "Sadaqah",
